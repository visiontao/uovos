...
% sequenceName = 'birdfall';
% path_images = strcat('../data/images/',sequenceName);
% img_dir = dir(strcat(path_images,'/','*.png'));
% 
% %% set parameters
% k1 = 10;
% k2 = k1+1;
...
% %% load image frame
% im1 = im2double(imread(strcat(path_images,'/', img_dir(k1).name)));
% im2 = im2double(imread(strcat(path_images,'/', img_dir(k2).name)));
